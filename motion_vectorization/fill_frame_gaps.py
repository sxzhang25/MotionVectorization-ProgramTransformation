...
#     os.makedirs(rgb_folder)
  print(os.path.join(arg.video_dir, arg.video_file))
  ...
  while True:
    ...
    #   src = os.path.join("outputs", f"{video_name}_None", "outputs", "track", f"{prev_frame_idx + 1:03d}.png")
    #   dst = os.path.join("outputs", f"{video_name}_None", "outputs", "track", f"{frame_idx + 1:03d}.png")
      src = os.path.join("videos", f"{video_name}", "rgb", f"{prev_frame_idx + 1:03d}.png")
      dst = os.path.join("videos", f"{video_name}", "rgb", f"{frame_idx + 1:03d}.png")
